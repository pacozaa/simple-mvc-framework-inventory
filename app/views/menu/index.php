        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="<?php echo DIR;?>"><i class="fa fa-fw  fa-pencil-square-o"></i> เพิ่มสินค้า</a>
                    </li>                  
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-pencil-square-o"></i>  <a href="<?php echo DIR;?>">เพิ่มสินค้า</a>
                            </li>
                            <!-- <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input id="file-0a" class="file" name="fileToUpload" class="form-control" type="file" multiple data-min-file-count="1">
                        </div>                        
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="productDescription" class="form-control" placeholder="คำบรรยาย">
                        </div>
